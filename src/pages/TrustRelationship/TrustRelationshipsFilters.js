...
export const StateSelectFilter = ({ filter, setFilter, statesList, getStatusColor }) => {
    ...
    return (
      <FormControl sx={{ width: '192px', marginBottom: '10px' }} data-testid='state-select-filter'>
  ...
  export const RequestTypeSelectFilter = ({ filter, setFilter, requestTypeList, getStatusColor }) => {
    ...
    return (
      <FormControl sx={{ width: '192px', marginBottom: '10px' }} data-testid='requestType-select-filter'>
